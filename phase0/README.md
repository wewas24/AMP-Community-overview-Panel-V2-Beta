...
- Gleichzeitige anfängliche API-Ladevorgänge für 1, 10, 50, 100 und 250 Besucher – getrennt für den einfachen Modus (nur Übersicht) und den erweiterten Modus (Übersicht plus eine kompakte Sammelabfrage für sichtbare Diagramme)
